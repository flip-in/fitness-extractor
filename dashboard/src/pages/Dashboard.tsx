...
export function Dashboard() {
	...
	useEffect(() => {
		...
		const onKeyDown = (e: KeyboardEvent) => {
			if (e.key === "Escape") closeWorkoutDetails();
		};
		...
		<div className="min-h-screen bg-gray-50 dark:bg-gray-900">
			...
			{selectedWorkout && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
					{/* Focusable backdrop: a real button so closing works by click and by
					    keyboard. A div with onKeyDown never fires — it can't take focus. */}
					<button
						type="button"
					...
					<div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
						<div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex items-start justify-between">
							<div>
								...
								<p className="text-gray-600 dark:text-gray-400">
									{formatDateTime(
										selectedWorkout.start_date,
										getTimezone(selectedWorkout.metadata),
									)}
								</p>
							</div>
							<button
						...
						<div className="p-6 space-y-6">
							...
							{selectedWorkout.metadata &&
								Object.keys(selectedWorkout.metadata).length > 0 && (
									<div>
										<h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
											Additional Info
										</h3>
